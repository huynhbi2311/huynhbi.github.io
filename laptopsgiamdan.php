...
?>
		 ...
		 <ul>
		                  ...
		                  <li><a href="laptopsgiamdan.php" class="nav-link scrollto active">Giảm dần</a></li>
 ...
 ?>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item "  style="width: 25%">
            ...
            <div class="portfolio-wrap" >
              <img src="./assets/img/<?php echo $lt['laptop_image']; ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
            
                <div class="portfolio-links">
                   <a href="laptop.php?laptopisbn=<?php echo $lt['laptop_isbn']; ?>" data-aos="fade-up" data-aos-delay="200" class="btn-get-started scrollto" > <button class="custom-btn btn-8" style="width: 100px;border-radius: 10px"  > <span style="font-size: 9pt">Xem Chi Tiết</span></button></a>
                </div>
             ...
             <a href="laptop.php?laptopisbn=<?php echo $lt['laptop_isbn']; ?>" style="text-decoration: none; color: black;">
               <p align="center" style="font-size: 10pt"> <?php echo $lt['laptop_title']; ?> <br></p>
             
               <p align="center" style="color: red; font-size: 9pt"><b><?php echo $format_number = number_format($lt['laptop_price']) ; ?>₫  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>      <del style="color:gray; font-size: 8pt;"><?php echo $format_number = number_format($lt['laptop_khuyenmai']) ; ?>₫ </del></p></a>
