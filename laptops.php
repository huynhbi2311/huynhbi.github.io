...
<body>
  ...
  <input type="search" name="search" placeholder="Search" value="<?php if (isset($_GET['search'])){ echo $_GET['search'];} 
     ?>">
          ...
          <li class="dropdown "><a href="laptops.php"  class="nav-link scrollto active">Laptops </a>
...
?>
  ...
  <section id="portfolio" class="portfolio">
      <div class="container" style="box-shadow: 0px 0 30px rgb(21 21 21 / 8%);margin-top: -10px; border-radius: 30px">
  <div class="row" style="width: 50%;margin-bottom: 30px">
<nav id="navbar" class="navbar">

 <?php 
    require_once "perpub.php"; ?>
             <?php 
    require_once "pubprice.php"; ?>
    <ul>
      <li class="dropdown"><a href="#" style="color:grey"><span>Sắp xếp </span> <i class="bi bi-chevron-right"></i></a>
 ...
 <!--  <p class="lead">List of Nhãn Hàng</p> -->
 </div>
...
<?php while($query_row = mysqli_fetch_assoc($result)){ ?>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item "  style="width: 25%;">
            ...
            <div class="portfolio-wrap" >
              <img src="./assets/img/<?php echo $query_row['laptop_image']; ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
            
                <div class="portfolio-links">
                   <a href="laptop.php?laptopisbn=<?php echo $query_row['laptop_isbn']; ?>" data-aos="fade-up" data-aos-delay="200" class="btn-get-started scrollto" > <button class="custom-btn btn-8" style="width: 100px;border-radius: 10px"  > <span style="font-size: 9pt">Xem Chi Tiết</span></button></a>
                </div>
             ...
             <a href="laptop.php?laptopisbn=<?php echo $query_row['laptop_isbn']; ?>" style="text-decoration: none; color: black;">
               <p align="center" style="font-size: 10pt"> <?php echo $query_row['laptop_title']; ?> <br></p>
             
               <p align="center" style="color: red; font-size: 9pt"><b><?php echo $format_number = number_format($query_row['laptop_price']) ; ?>₫  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>      <del style="color:gray; font-size: 8pt;"><?php echo $format_number = number_format($query_row['laptop_khuyenmai']) ; ?>₫ </del></p></a>
